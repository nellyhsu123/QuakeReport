...
public final class QueryUtils {
    ...
    private static List<Earthquake> extractEarthquakes(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray jsonEquake = jsonObj.optJSONArray("features");

            for(int i = 0; i < jsonEquake.length(); ++i){
                JSONObject e = jsonEquake.getJSONObject(i);
                JSONObject properties = e.optJSONObject("properties");
